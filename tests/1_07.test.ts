...
test("1.07", async () => {
  ...
  expect(row).toHaveProperty("userIdentity.sessionContext.sessionIssuer.arn", "arn:aws:iam::111122223333:role/AppRole");
  expect(row).toHaveProperty("userIdentity.sessionContext.sessionIssuer.accountId", "111122223333");
  expect(row).toHaveProperty("userIdentity.sessionContext.sessionIssuer.userName", "AppRole");
  expect(row).toHaveProperty("userIdentity.sessionContext.attributes.creationDate", "2021-04-10T08:00:00Z");
